...
from agentsoul.common import get_project_root, log  # noqa: E402
from agentsoul.abstract import (  # noqa: E402
    UnifiedSoulStorage,
)
from agentsoul.common.health_gate import (  # noqa: E402
    UnifiedCheckResult,
    calculate_gate_result,
    handle_summary_output,
)
from agentsoul.storage.local import (  # noqa: E402
    LocalMemoryStorage,
    LocalPersonaStorage,
    LocalSkillStorage,
...
class CompanionshipChecker:
    ...
    def check_memory_continuity(self) -> CheckResult:
        ...
        base_dir = self.project_root / "var" / "data" / "memory"
    ...
    def check_state_recovery(self) -> CheckResult:
        ...
        history_dir = self.project_root / "var" / "data" / "soul" / "versions"
    ...
    def check_user_perceived_companionship(self) -> CheckResult:
        ...
        if self._memory_count is None:
            ...
            self._memory_count = 0
            memory_dir = self.project_root / "var" / "data" / "memory"
        ...
        data_dir = self.project_root / "var" / "data"
        if data_dir.exists():
            try:
