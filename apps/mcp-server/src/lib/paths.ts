...
function findProjectRoot(): string {
  ...
  // Fallback 1: direct path calculation based on current layout
  // - Source:  .../AgentSoul/apps/mcp-server/src/lib
  // - Compiled: .../AgentSoul/apps/mcp-server/dist/lib
  // Both cases need to go up 4 levels to reach AgentSoul root.
...
/** Data root directory */
export const DATA_ROOT = path.join(PROJECT_ROOT, 'var', 'data');
