  ...
  companion: {
    ...
    petAppearance: {
      ...
      assetManifest: {
        ...
        frame: { width: 192, height: 208, count: 72 },
        fps: 6,
        states: {
          idle: { frames: [0, 1, 2, 3, 4, 5], loop: true, fps: 5 },
          blink: { frames: [0, 2, 3, 4, 5], loop: true, fps: 5 },
          happy: { frames: [24, 25, 26], loop: true, fps: 6 },
          attention: { frames: [0, 1, 4, 5], loop: true, fps: 5 },
          sleep: { frames: [40, 41, 42, 43, 44], loop: true, fps: 5 },
          degraded: { frames: [64, 65, 66, 67], loop: true, fps: 5 },
        },
      },
    },
    mood: "neutral",
